    ...
    (function (formatting) {
        var FormattingContext = (function () {
            ...
            FormattingContext.prototype.BlockIsOnOneLine = function (node) {
                var openBrace = ts.findChildOfKind(node, ts.SyntaxKind.OpenBraceToken, this.sourceFile);
                var closeBrace = ts.findChildOfKind(node, ts.SyntaxKind.CloseBraceToken, this.sourceFile);
...
//# sourceMappingURL=formattingContext.js.map